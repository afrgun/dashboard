...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-info">
            <div class="box-body">
              <div class="row">
                <form id="getdataforabsensi_form" class="form-horizontal" method="post" action="<?php SCRIPT_ROOT ?>service/absensi/searchdata.php">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-12">
                    <input id="getDataForAbsensi" type="submit" class="btn btn-info pull-right" value="Cari Data">
                  </div>
                </form>
                <form method="post" action="<?php SCRIPT_ROOT ?>service/absensi/submit_absensi.php">
     
                  <div class="col-md-12 table-absensi-siswa">

                    <table id="tableAbsensi" class="table table-bordered">
                      <thead>
                        <tr>
                          <th rowspan="2">No ID</th>
                          <th rowspan="2">Nama Anak</th>
                          <th colspan="3" class="center">Kehadiran</th>
                        </tr>
                        <tr>
                          <th>Hadir</th>  
                          <th>Sakit</th>
  ...
  <!-- <thead>
                      ...
                      <tbody> -->
                        <?php
                          ...
                          //     $return .='
                          //     <tr>
                          //       <td><input class="inputhide" type="text" name="id_siswa[]" value="'.$value['id_siswa'].'">'.$no.'</td>
                          //       <td><input class="inputhide" type="text" name="nama_lengkap[]" value="'.$value['nama_lengkap'].'">'.$value['nama_lengkap'].'</td>
                          //       <td>   
                          //         <input type="radio" name="'.$value['id_regis'].'" value="hadir">
                          //       </td>
                          //       <td>
                          //         <input type="radio" name="'.$value['id_regis'].'" value="sakit">
                          //       </td>
                          //       <td>
                          //         <input type="radio" name="'.$value['id_regis'].'" value="alpha">
                          //       </td>
                          //     </tr>
                          //     ';
                          //   }  
