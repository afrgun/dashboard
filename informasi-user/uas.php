...
include '../service/penilaian/service-uas.php';
      ...
      <div class="row flex-center">
        <div class="col-xs-11">
          ...
          <div class="box box-primary">
            ...
            <h3 class="text-center">LAPORAN REKAPITULASI KBM SISWA AKHIR SEMESTER</h3>
            <br/><br/>
              ...
              <a target="_blank" href="../report/report-siswa-uas.php" class="btn btn-primary btn-block"><b>Print</b></a>
            </div>
            <!-- /.box-body -->
          </div>
