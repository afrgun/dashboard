...
<div class="content-wrapper">
    <section class="content-header">
      <h1>
        ...
        <div class="col-xs-3 mb-3 pull-right">
          <a target="_blank" href="report/report-nilai-uts.php" class="btn btn-block btn-primary">Print Data UTS</a>
        </div>
      </h1>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-info">
            <div class="box-body">
              <div class="row">
                <form id="getdatafornilaiuts_form" class="form-horizontal" method="post" action="<?php SCRIPT_ROOT ?>service/penilaian/searchdata.php">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-12">
                    <input id="getDataForNilaiUTS" type="submit" class="btn btn-info pull-right" value="Cari Data">
                  </div>
                </form>
                <form method="post" action="<?php SCRIPT_ROOT ?>service/penilaian/submit_penilaian_uts.php">
     
                  <div class="col-md-12 table-absensi-siswa">

                    <table id="tablePenilaianuts" class="table table-bordered">
                      <thead>
                        <tr>
                          <th>No ID</th>
                          <th>Nama Anak</th>
